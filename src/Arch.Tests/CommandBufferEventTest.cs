...
public sealed class CommandBufferEventTest
{
    ...
    public void CreateAndSet_EmitsSingleAddWithValue()
    {
        ...
        world.SubscribeComponentSet<EventBufferTestComponent>((in Entity entity, ref EventBufferTestComponent cmp) => set.Add((entity, cmp.Value)));
    ...
    public void SetOnExistingComponent_EmitsSingleSet()
    {
        ...
        Assert.That(set[0].Value, Is.EqualTo(7));
    ...
    public void CancelledCreate_EmitsNoEvents()
    {
        ...
        world.SubscribeComponentSet<EventBufferTestComponent>((in Entity entity, ref EventBufferTestComponent _) => set.Add(entity));
    ...
    public void SetTwice_EmitsSingleSetWithFinalValue()
    {
        ...
        Assert.That(set, Has.Count.EqualTo(1));
        Assert.That(set[0].Value, Is.EqualTo(2), "值为最终写入值");
    }
    ...
    public void SetTwoComponents_EmitsSetPerComponent()
    {
        ...
        var setComponent = new List<Entity>();
        var setTransform = new List<Entity>();
        var added = new List<Entity>();
        world.SubscribeComponentSet<EventBufferTestComponent>((in Entity entity, ref EventBufferTestComponent _) => setComponent.Add(entity));
        world.SubscribeComponentSet<Transform>((in Entity entity, ref Transform _) => setTransform.Add(entity));
        world.SubscribeComponentAdded<EventBufferTestComponent>((in Entity entity, ref EventBufferTestComponent _) => added.Add(entity));
